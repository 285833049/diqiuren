...
public class BasePreferences {
	...
	public boolean getBoolean(String key, boolean defaultValue) {
		return null != preferenses ? preferenses.getBoolean(key, defaultValue) : defaultValue;
	}
	...
	public boolean getBoolean(String key) {
		return null != preferenses ? preferenses.getBoolean(key, true) : true;
	}
