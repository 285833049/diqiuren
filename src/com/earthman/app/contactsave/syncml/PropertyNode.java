...
package com.earthman.app.contactsave.syncml;
...
import com.earthman.app.contactsave.content.ContentValues;
...
public class PropertyNode {
     ...
     * TODO: fix this. 
     */
    public com.earthman.app.contactsave.content.ContentValues paramMap;
    ...
    public static PropertyNode decode(String encodedString) {
        ...
        for (String elem : elems) {
            ...
            if (name.equals("propName")) {
                ...
                com.earthman.app.contactsave.content.ContentValues paramMap = propertyNode.paramMap;
