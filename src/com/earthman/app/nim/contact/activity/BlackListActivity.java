...
import com.earthman.app.nim.contact.viewholder.BlackListViewHolder;
 ...
 */
public class BlackListActivity extends Activity implements TAdapterDelegate, OnClickListener {
    private static final String TAG = "BlackListActivity";
    private static final int REQUEST_CODE_BLACK = 1;

    private ListView listView;
    private List<UserInfoProvider.UserInfo> data = new ArrayList<UserInfoProvider.UserInfo>();
    ...
    private void initTitlebar() {
    	((TextView)findViewById(R.id.tv_left)).setText(R.string.black_list);
	...
	public void onClick(View v) {
		...
		case R.id.btn_right:
            ...
            ArrayList<String> excludeAccounts = new ArrayList<String>();
