...
public class StickerManager {
    ...
    private Map<String, StickerCategory> stickerCategoryMap = new HashMap<String, StickerCategory>();
    private Map<String, Integer> stickerOrder = new HashMap<String, Integer>(3);

    /**
     * ImageLoader
     */
    private Map<Integer, DisplayImageOptions> stickerImageOptions = new HashMap<Integer, DisplayImageOptions>(2);
