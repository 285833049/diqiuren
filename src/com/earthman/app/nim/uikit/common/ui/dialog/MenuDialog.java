package com.earthman.app.nim.uikit.common.ui.dialog;
...
public class MenuDialog extends Dialog implements View.OnClickListener {
	...
	public MenuDialog(Context context, List<String> btnNames, int selectIndex, int invalidSelectIndex, MenuDialogOnButtonClickListener listener) {
	...
	private void selectItem() {
		if (selectMode == false || selectIndex < 0 || selectIndex >= btnNames.size() || itemViews == null || itemViews.isEmpty()) {
			return;
		}
