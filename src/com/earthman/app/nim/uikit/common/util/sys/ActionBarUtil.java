package com.earthman.app.nim.uikit.common.util.sys;
...
public class ActionBarUtil {
	...
	public static TextView addRightClickableTextViewOnActionBar(TActionBarActivity activity, int strResId, View.OnClickListener l) {
		return addRightClickableTextViewOnActionBar(activity, activity.getString(strResId), l);
	}

	public static TextView addRightClickableTextViewOnActionBar(TActionBarActivity activity, String text, View.OnClickListener l) {
	...
	public static TextView addRightClickableTextViewOnActionBar(TActionBarActivity activity, String text) {
		...
		actionBar.setCustomView(view, new ActionBar.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.RIGHT | Gravity.CENTER));
		return textView;
	}
	...
	public static View addRightCustomViewOnActionBar(TActionBarActivity activity, int layoutID, int width, int height) {
		...
		actionBar.setCustomView(view, new ActionBar.LayoutParams(width, height, Gravity.RIGHT | Gravity.CENTER));
		return view;
	}
