package com.earthman.app.nim.uikit.common.media.picker.activity;
...
import com.earthman.app.nim.uikit.common.media.picker.fragment.PickerAlbumFragment;
import com.earthman.app.nim.uikit.common.media.picker.fragment.PickerAlbumFragment.OnAlbumItemClickListener;
import com.earthman.app.nim.uikit.common.media.picker.fragment.PickerImageFragment;
import com.earthman.app.nim.uikit.common.media.picker.fragment.PickerImageFragment.OnPhotoSelectClickListener;
import com.earthman.app.nim.uikit.common.media.picker.loader.PickerConfig;
import com.earthman.app.nim.uikit.common.media.picker.loader.PickerlImageLoadTool;
import com.earthman.app.nim.uikit.common.media.picker.model.AlbumInfo;
import com.earthman.app.nim.uikit.common.media.picker.model.PhotoInfo;
import com.earthman.app.nim.uikit.common.media.picker.model.PickerContract;
import com.earthman.app.nim.uikit.session.constant.Extras;
import com.earthman.app.nim.uikit.session.constant.RequestCode;
import com.earthman.app.utils.FragmentUtils;

/**
 * Inner image picker, no longer use third-part application 
 */
public class PickerAlbumActivity extends FragmentActivity implements OnAlbumItemClickListener,
	...
	private void initTitlebar(){
		...
		((TextView)findViewById(R.id.tv_left)).setText(R.string.picker_image_folder);
	}
...
//		switchContent(photoFolderFragment);
		FragmentUtils.commit(this, R.id.picker_album_fragment, photoFolderFragment);
		isAlbumPage = true;
	}
...
//			switchContent(photoFragment);
			FragmentUtils.commit(this, R.id.picker_photos_fragment, photoFragment);
		} else {
