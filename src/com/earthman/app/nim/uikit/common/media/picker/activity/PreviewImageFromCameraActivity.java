...
public class PreviewImageFromCameraActivity extends Activity implements OnClickListener {
	...
	private void initTitleBar() {
		((TextView) findViewById(R.id.tv_left)).setText("拍摄");
		Button btnRight = (Button) findViewById(R.id.btn_right);
		btnRight.setText(R.string.recapture);
