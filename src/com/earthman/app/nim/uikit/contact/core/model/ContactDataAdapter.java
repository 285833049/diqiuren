...
import com.earthman.app.nim.uikit.contact.core.model.ContactDataTask.Host;
...
public class ContactDataAdapter extends BaseAdapter {
	...
	protected final HashMap<String, Integer> indexes = new HashMap<String, Integer>();
	...
	public ContactDataAdapter(Context context, ContactGroupStrategy groupStrategy, IContactDataProvider dataProvider) {
		...
		this.viewHolderMap = new HashMap<Integer, Class<? extends AbsContactViewHolder<? extends AbsContactItem>>>(6);
	}
	 ...
	 * 
	 * @param query
	 *            要搜索的信息，填null表示查询所有数据
	 * @param abort
	 *            是否终止：例如搜索的时候，第一个搜索词还未搜索完成，第二个搜索词已生成，那么取消之前的搜索任务
	 */
