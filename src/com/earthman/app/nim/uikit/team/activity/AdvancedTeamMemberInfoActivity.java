 ...
 */
public class AdvancedTeamMemberInfoActivity extends Activity implements View.OnClickListener {
    ...
    private void initTitlebar(){
    	...
    	((TextView)findViewById(R.id.tv_left)).setText(R.string.team_member_info);
    }
