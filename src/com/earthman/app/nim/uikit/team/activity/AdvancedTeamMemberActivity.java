 ...
 */
public class AdvancedTeamMemberActivity extends Activity implements TAdapterDelegate,
    ...
    private void initTitlebar(){
    	...
    	((TextView)findViewById(R.id.tv_left)).setText(R.string.team_member);
    }
...
//    	intent.putExtra("friendsuserid", account);
