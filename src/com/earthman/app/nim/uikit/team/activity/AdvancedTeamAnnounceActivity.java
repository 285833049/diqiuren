...
import com.earthman.app.nim.uikit.team.viewholder.TeamAnnounceHolder;
 ...
 */
public class AdvancedTeamAnnounceActivity extends Activity implements TAdapterDelegate, OnClickListener {
	// constant
	...
	private void initTitlebar() {
		...
		((TextView) findViewById(R.id.tv_left)).setText(R.string.team_annourcement);
		Button btnCreate = (Button) findViewById(R.id.btn_right);
		btnCreate.setText(getString(R.string.create));
		btnCreate.setOnClickListener(this);
	}

	private void initAdapter() {
		items = new ArrayList<Announcement>();
