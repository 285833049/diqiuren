...
import com.earthman.app.nim.uikit.common.ui.dialog.MenuDialog;
...
import com.earthman.app.nim.uikit.team.model.Announcement;
 ...
 */
public class AdvancedTeamInfoActivity extends Activity implements
        TAdapterDelegate, TeamMemberAdapter.AddMemberCallback, TeamMemberHolder.TeamMemberHolderEventListener, OnClickListener {
    ...
    private void initTitlebar() {
    	...
    	Button btnSettings=(Button) findViewById(R.id.btn_right);
    	btnSettings.setText(R.string.menu);
...
//        });
    ...
    private void loadTeamInfo() {
        ...
        ((TextView)findViewById(R.id.tv_left)).setText(team.getName());
    }
    ...
    private void onTransferTeam() {
        ...
        ArrayList<String> includeAccounts = new ArrayList<String>();
