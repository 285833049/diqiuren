...
public class NimUserInfoCache {
    ...
    private Map<String, List<RequestCallback<NimUserInfo>>> requestUserInfoMap = new ConcurrentHashMap<String, List<RequestCallback<NimUserInfo>>>(); // 重复请求处理
    ...
    public List<NimUserInfo> getAllUsersOfMyFriend() {
        ...
        List<NimUserInfo> users = new ArrayList<NimUserInfo>();
