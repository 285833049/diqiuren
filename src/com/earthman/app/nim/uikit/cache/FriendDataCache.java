package com.earthman.app.nim.uikit.cache;
...
public class FriendDataCache {
     ...
     * 属性
     */
    private Set<String> friendAccountSet = new CopyOnWriteArraySet<String>();

    private Map<String, Friend> friendMap = new ConcurrentHashMap<String, Friend>();

    private List<FriendDataChangedObserver> friendObservers = new ArrayList<FriendDataChangedObserver>();
    ...
    public List<String> getMyFriendAccounts() {
        List<String> accounts = new ArrayList<String>(friendAccountSet.size());
    ...
    private Observer<FriendChangedNotify> friendChangedNotifyObserver = new Observer<FriendChangedNotify>() {
        ...
        public void onEvent(FriendChangedNotify friendChangedNotify) {
            ...
            List<String> myFriendAccounts = new ArrayList<String>(addedOrUpdatedFriends.size());
            List<String> friendAccounts = new ArrayList<String>(addedOrUpdatedFriends.size());
