package com.earthman.app.nim.main.reminder;
...
public class ReminderManager {
    ...
    // observers
    private SparseArray<ReminderItem> items = new SparseArray<ReminderItem>();

    private List<UnreadNumChangedCallback> unreadNumChangedCallbacks = new ArrayList<UnreadNumChangedCallback>();
