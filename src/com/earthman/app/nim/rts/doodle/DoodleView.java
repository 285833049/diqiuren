package com.earthman.app.nim.rts.doodle;
...
import com.earthman.app.nim.rts.doodle.action.Action;
...
public class DoodleView extends SurfaceView implements SurfaceHolder.Callback, TransactionObserver {
    ...
    public void onTransaction(List<Transaction> transactions) {
        ...
        List<Transaction> cache = new ArrayList<Transaction>(transactions.size());
