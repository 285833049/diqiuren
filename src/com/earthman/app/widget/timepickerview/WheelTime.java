...
import com.earthman.app.widget.timepickerview.TimePickerView.Type;
...
public class WheelTime {
	...
	public WheelTime(View view,TextView time_year,TextView time_month,TextView time_day,Type type) {
		super();
		this.view = view;
		this.type = type;
	...
	public void setPicker(int year ,int month ,int day,int h,int m) {
		...
		wv_day.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				time_day.setText((wv_day.getCurrentItem()+1)+"日");
			}
		});
		...
		OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				time_month.setText(month_num+"月");
				int maxItem = 30;
				// 判断大小月及是否闰年,用来确定"日"的数据
