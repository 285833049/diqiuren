package com.earthman.app.widget.selectphoto;
...
import com.earthman.app.widget.selectphoto.GirdItemAdapter.OnPhotoSelectedListener;
...
public class SelectPhotoActivity extends Activity {
	...
	private void setView() {
		...
		photoGrid.setOnScrollListener(new PauseOnScrollListener(ImageLoader.getInstance(), false, true));
	}
	...
	private void initListDirPopupWindw() {
		if (popupWindow == null) {
			...
			dirListView.setOnScrollListener(new PauseOnScrollListener(ImageLoader.getInstance(),false,true));
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case TAKE_CAMERA_PICTURE:
			...
			if (Activity.RESULT_OK == resultCode) {
				...
				intent.putExtra("Bigimage", picpath);
