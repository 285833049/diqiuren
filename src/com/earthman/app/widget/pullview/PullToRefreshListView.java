package com.earthman.app.widget.pullview;
...
import com.earthman.app.widget.pullview.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        mListView = listView;
        mListView.setDivider(new ColorDrawable(getResources().getColor(R.color.black_c)));
