...
import com.earthman.app.nim.contact.activity.BlackListActivity;
import com.earthman.app.nim.main.activity.SystemMessageActivity;
import com.earthman.app.nim.main.activity.TeamListActivity;
import com.earthman.app.nim.main.helper.SystemMessageUnreadManager;
import com.earthman.app.nim.main.reminder.ReminderId;
...
//            items.add(MY_COMPUTER);
        ...
        public static void handle(Context context, AbsContactItem item) {
            if (item == VERIFY) {
                ...
                SessionHelper.startP2PSession(context, NimCache.getAccount());
            } else if (item == BLACK_LIST) {
...
//        onCurrent(); // 触发onInit，提前加载
    ...
    private void addContactFragment() {
        ...
        fragment.setContainerId(R.id.ll_container);
